...
This one-shot runner consolidates optimized IPv4 and IPv6 candidates with eleven BestCF and GitHub community text feeds, including five IPv6-only pools, measures latency and transfer speed, and publishes the top 10 results in each IPv4, IPv6, and domain sector. GitHub Actions starts it every 15 minutes; it does not modify DNS records.
